...
export class MyForm extends StaticElement {
  template(state, u) {
    return `
        ...
        <my-input class="col-12 col-md-6 col-lg-3" name="name" label="${u.i18n('name')}" context="${this.context}"></my-input>
        <my-input class="col-12 col-md-6 col-lg-3" name="surname" label="${u.i18n('surname')}" context="${this.context}"></my-input>
